...
*/
#define TIMERS_u8_TIMER0_CLOCK_SOURCE     TIMERS_u8_TIMER0_NO_PRESCALER
...
#define TIMERS_u8_TIMER0_COMPARE_MATCH_OCR0       200
...
*/
#define TIMERS_u8_TIMER1_CLOCK_SOURCE     TIMERS_u8_TIMER1_NO_PRESCALER
